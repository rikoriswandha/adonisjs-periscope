...
const SIDEBAR_WIDTH: string = "14rem";
const SIDEBAR_WIDTH_MOBILE: string = "16rem";
...
export function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    async (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persist collapse state when Cookie Store is available.
      try {
        ...
        // Cookie persistence is best-effort for local tooling.
      }
    },
    [setOpenProp, open],
  );
...
export function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90%, generated once in the state initializer
  // where impurity is allowed.

...
[Upgrading Periscope](/guides/upgrading).

The [versioned batch-export envelope](/reference/batch-export) is the exception: it is a stable interchange
...
[batch export reference](/reference/batch-export), as a download. An unknown or empty batch returns `404`.

...
[batch export format](/adonisjs-periscope/reference/batch-export) for the stable envelope and public
parser.
...
See [Operations](/adonisjs-periscope/guides/operations) for retention, shared-store scope, diagnostics,

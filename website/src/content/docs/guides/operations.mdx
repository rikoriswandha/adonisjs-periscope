---
title: Operations
description: Run durable stores, retention, multi-process deployments, and temporary production recording.
sidebar:
  order: 3
---
...
[Authoring adapters](/adonisjs-periscope/reference/adapters#flush-fanout) for the contract and a skeleton.

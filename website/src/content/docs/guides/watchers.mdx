---
title: Watchers and commands
description: Understand recorded signals, extension hooks, operational commands, and common failures.
sidebar:
  order: 2
---
...
[Authoring adapters](/adonisjs-periscope/reference/adapters).
...
See [Authoring adapters](/adonisjs-periscope/reference/adapters) for hook examples, complete adapter interfaces,
...
[Testing](/adonisjs-periscope/guides/testing) for setup, signatures, and examples.

...
[Testing](/adonisjs-periscope/guides/testing) for setup and application-scoped cleanup.
...
`StoredEntryTransport`. See the [batch export reference](/adonisjs-periscope/reference/batch-export) before producing or consuming exports
outside Periscope.
...
package version and follow the [HTTP API reference](/adonisjs-periscope/reference/http-api).

...
- [Dashboard and security](/adonisjs-periscope/guides/dashboard): navigation, live updates, and safe access
- [Watchers and troubleshooting](/adonisjs-periscope/guides/watchers): recorded signals, capture behavior, and common failures
- [Operations](/adonisjs-periscope/guides/operations): shared stores, retention, and production posture
- [Testing](/adonisjs-periscope/guides/testing): recorder assertions and the Japa plugin
- [Configuration](/adonisjs-periscope/reference/configuration): every option, default, and merge rule
- [CLI commands](/adonisjs-periscope/reference/commands): diagnosis, maintenance, pause, export, and import
- [Architecture](/adonisjs-periscope/reference/architecture): runtime pipeline, lifecycle, storage, and invariants
- [HTTP API](/adonisjs-periscope/reference/http-api): experimental dashboard JSON and SSE routes
- [Adapter authoring](/adonisjs-periscope/reference/adapters): watcher, integration, store, and fanout seams
- [Batch export](/adonisjs-periscope/reference/batch-export): versioned `periscope.batch` interchange schema
- [Upgrading](/adonisjs-periscope/guides/upgrading): release-specific migration notes
...
the [configuration reference](/adonisjs-periscope/reference/configuration) documents every option,

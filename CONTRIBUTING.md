...
npm -w @rikology/adonisjs-periscope test -- --files="unit/recorder/redactor.spec.ts"
npm -w @rikology/adonisjs-periscope test -- --files="storage/sqlite_local_store.spec.ts"
...
npm -w @rikology/adonisjs-periscope run build

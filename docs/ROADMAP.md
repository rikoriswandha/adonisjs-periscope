...
1. Quick fixes (items 1-4, 20) — one small PR.
2. Bucketed stats API (5) + per-route table + level filter (6) — unlocks four dashboard features at once.
3. Testing export (21) + doctor command (22) — converts evaluators into adopters.
4. SSE efficiency (18) + per-type retention (11) + tag scoping (12).
5. Vine + scheduler watchers.
6. Waterfall (14) + exception triage (15).
7. Multi-process story (7-10) — deepest work; design and execute as one wave, not piecemeal.

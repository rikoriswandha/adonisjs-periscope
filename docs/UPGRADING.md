...
[TESTING.md](TESTING.md) for setup and application-scoped cleanup.
...
`StoredEntryTransport`. See [BATCH_EXPORT.md](BATCH_EXPORT.md) before producing or consuming exports
outside Periscope.
...
package version and follow [API.md](API.md).
